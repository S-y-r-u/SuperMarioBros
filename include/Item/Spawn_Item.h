...
public:
    ...
    static void Hidden_Coin_Spawner(std::vector<Item *> &items, Vector2 pos, Player &player);
    ...
    static void Item_Spawn(const std::string &type_item, std::vector<Item *> &items, Vector2 pos, Player &player);
};
